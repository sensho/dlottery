...
export const DEV_SERVER = 'http://localhost:8000/v1'
// export const DEV_SERVER = 'https://a196-2401-4900-1cdf-edfd-d89a-68ff-ec3e-a152.in.ngrok.io/v1'
// export const DEV_SERVER = 'http://100.25.163.237:8000/v1'
